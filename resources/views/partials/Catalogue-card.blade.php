                ...
                <div class="card col-lg-3 m-2">
                    <div class="view overlay">
                        <a href="{{route('Catalogue.view', ['estampa' => $estampa])}}">
                            <img class="card-img-top estampa-img" id="card-img-top" src="{{$estampa->imagem_url ? asset('storage/estampas/' . $estampa->imagem_url) : asset('img/default_img.jpg') }}" alt="Imagem da Estampa">
                        </a>
