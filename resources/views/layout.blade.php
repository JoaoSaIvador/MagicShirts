  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Loja MagicShirts</div>
      </a>
      ...
      <li class="nav-item {{Route::currentRouteName()=='catalogo.index'? 'active': ''}}">
        ...
        <!-- Nav Item -->
        <li class="nav-item {{Route::currentRouteName()=='encomendas.index'? 'active': ''}}">
            <a class="nav-link" href="{{route('encomendas.index')}}">
              <i class="fas fa-fw fa-truck"></i>
              <span>Encomendas</span></a>
        </li>
        <!-- Nav Item -->
       <li class="nav-item {{Route::currentRouteName()=='estampasProprias.index'? 'active': ''}}">
            <a class="nav-link" href="{{route('estampasProprias.index')}}">
          <i class="fas fa-fw fa-magic"></i>
          <span>Estampas Próprias</span></a>
        </li>
